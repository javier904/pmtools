...
/// Dialog for selecting tasks to export to Estimation Room
class ExportToEstimationDialog extends StatefulWidget {
  final TodoListModel list;
  final List<TodoTaskModel> tasks;

  const ExportToEstimationDialog({
    super.key,
    required this.list,
    required this.tasks,
  });
  ...
  @override
  State<ExportToEstimationDialog> createState() => _ExportToEstimationDialogState();
}

class _ExportToEstimationDialogState extends State<ExportToEstimationDialog> {
  final Set<String> _selectedTaskIds = {};
  String? _selectedColumnId; // null = All columns
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.casino_rounded, color: Colors.green),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          l10n.exportToEstimation,
                          style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
                        ),
                        const SizedBox(height: 4),
                        Text(
                          l10n.exportToEstimationDesc,
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text(l10n.createEstimationSession),
