...
class EstimationRoomInviteTabWidget extends StatefulWidget {
  ...
  @override
  State<EstimationRoomInviteTabWidget> createState() => _EstimationRoomInviteTabWidgetState();
}

class _EstimationRoomInviteTabWidgetState extends State<EstimationRoomInviteTabWidget> {
  ...
  @override
  void didUpdateWidget(EstimationRoomInviteTabWidget oldWidget) {
  ...
  Future<void> _sendInvite() async {
    ...
    try {
      final invite = await _inviteService.createInvite(
        ...
        sourceName: widget.sessionTitle,
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(8),
          border: Border.all(
            color: isSelected ? AppColors.warning : context.borderColor,
        ...
        child: Row(
          ...
          children: [
            Icon(
              icon,
              size: 16,
              color: isSelected ? AppColors.warning : context.textSecondaryColor,
            ),
