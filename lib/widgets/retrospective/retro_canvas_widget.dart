  ...
  Widget _buildZone(BuildContext context, RetroColumn column, Alignment alignment) {
    ...
    return DragTarget<String>(
      ...
      onAccept: (itemId) {
        ...
        RetrospectiveFirestoreService().updateRetroItem(retro.id, newItem);
      },
              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    alignment: alignment == Alignment.topLeft || alignment == Alignment.bottomLeft ? WrapAlignment.start : WrapAlignment.end,
