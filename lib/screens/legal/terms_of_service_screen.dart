...
Accedendo o utilizzando **Agile Tools**, accetti di essere vincolato da questi Termini di Servizio ("Termini"). Se non accetti questi Termini, non devi utilizzare i nostri Servizi.

## 2. Descrizione del Servizio
Agile Tools è una piattaforma di collaborazione per team agili che offre strumenti come Smart Todo, Matrice di Eisenhower, Estimation Room e Gestione Processi Agili. Ci riserviamo il diritto di modificare o interrompere il servizio in qualsiasi momento.
...
Nella misura massima consentita dalla legge, Agile Tools viene fornito "così com'è" e "come disponibile". Non garantiamo che il servizio sarà ininterrotto o privo di errori. Non saremo responsabili per danni indiretti, incidentali o consequenziali derivanti dall'uso del servizio.
