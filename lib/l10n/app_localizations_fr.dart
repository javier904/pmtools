...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get actionExportPdf => 'Exporter un rapport PDF';
  ...
  @override
  String get feedbackReportBug => 'Signaler un bug';

  @override
  String get feedbackRequestFeature => 'Demander une fonctionnalité';

  @override
  String get feedbackHistory => 'Historique des retours';
  ...
  @override
  String get feedbackSubject => 'Sujet';

  @override
  String get feedbackSubjectHint => 'Décrivez brièvement le problème...';

  @override
  String get feedbackDescription => 'Description';

  @override
  String get feedbackDescriptionHint => 'Fournissez plus de détails ici...';

  @override
  String get feedbackConsent =>
      'J\'autorise le traitement de mes données pour suivre et enregistrer cette demande conformément à la politique de confidentialité.';

  @override
  String get feedbackSubmit => 'Envoyer';

  @override
  String get feedbackSuccess => 'Demande soumise avec succès !';

  @override
  String get feedbackError => 'Échec de la soumission de la demande';

  @override
  String get feedbackStatusNew => 'Nouveau';

  @override
  String get feedbackStatusInProgress => 'En cours';

  @override
  String get feedbackStatusResolved => 'Résolu';

  @override
  String get feedbackStatusClosed => 'Fermé';

  @override
  String get feedbackNoRequests => 'Aucune demande trouvée';

  @override
  String get feedbackAdminTitle => 'Administration des retours';
  ...
  @override
  String get eisenhowerPdfLegend => 'Légende des activités';

  @override
  String get eisenhowerPdfRaciTitle => 'Matrice de responsabilité RACI';

  @override
  String get marketingPdfFeatureTitle => 'Rapports PDF professionnels';

  @override
  String get marketingPdfFeatureDesc =>
      'Générez des rapports prêts à imprimer avec une grille de quadrants, un diagramme de dispersion et des matrices RACI pour vos réunions d\'équipe.';
  ...
  @override
  String get retroContinueAction => 'Continuer';

  @override
  String get retroCurrentPhase => 'Phase';

  @override
  String get retroNoCompletedRetros => 'Aucune rétrospective terminée';

  @override
  String get retroStandalone => 'Autonome';

  @override
  String get retroCompletedOn => 'Terminée';

  @override
  String get retroSummaryDetails => 'Détails';

  @override
  String get retroSummaryCompleted => 'Terminée';

  @override
  String get retroSummaryFacilitator => 'Facilitateur';
  ...
  @override
  String get retroSummaryNoCards => 'Aucune carte';
  ...
  @override
  String get agileEmptyStateTitle => 'Aucun Projet Agile';

  @override
  String get agileEmptyStateDesc =>
      'Créez votre premier projet pour commencer\nà gérer les sprints, le backlog et l\'équipe.';

  @override
  String get agileEmptyStateButton => 'Créer un Projet';

  @override
  String get agileEmptyStateGuideTitle =>
      'Vous ne savez pas quelle méthodologie choisir ?';

  @override
  String get agileEmptyStateGuideDesc =>
      'Découvrez les différences entre Scrum, Kanban et Hybrid. Le guide vous aidera à choisir la méthodologie la plus adaptée à votre équipe.';

  @override
  String get agileEmptyStateGuideButton => 'Lire le Guide';
  ...
  String velocityTooltipAverage(int count) {
    return 'Basé sur les $count derniers sprints terminés';
  }
  ...
  @override
  String get agileBurndownInfoTitle => 'Comment lire le Burndown Chart';

  @override
  String get agileBurndownInfoIdeal =>
      'La ligne **Idéale** (pointillée) montre la progression cible si le travail était terminé uniformément.';

  @override
  String get agileBurndownInfoActual =>
      'La ligne **Actuelle** (continue) montre le travail restant. Les stories terminées font baisser cette ligne.';

  @override
  String get agileBurndownInfoGoal =>
      'Votre objectif est de garder la ligne Actuelle en dessous de l\'Idéale pour finir à temps.';

  @override
  String get guideToolsTitle => 'Outils et Intégrations';

  @override
  String get guideJiraContent =>
      'L\'application s\'intègre à Jira pour garder le travail synchronisé.\n\nFonctionnalités principales:\n• **Import**: Les histoires créées dans Jira apparaissent ici.\n• **Lien**: En cliquant sur l\'ID de l\'histoire (ex. PROJ-123), Jira s\'ouvre directement.\n• **Sync**: Le statut se met à jour de manière bidirectionnelle (si configuré).';

  @override
  String get guideWorkflowTitle => 'Flux de travail et Qualité';

  @override
  String get guideAcceptanceCriteriaContent =>
      'Pour garantir la qualité, chaque histoire doit avoir des Critères d\'Acceptation clairs.\n\n• **Ajout Rapide**: Vous pouvez ajouter des critères directement depuis le détail de l\'histoire.\n• **Vérification**: Cochez les critères au fur et à mesure qu\'ils sont remplis.\n• **Definition of Done**: Une histoire est \'Done\' seulement lorsque tous les critères sont satisfaits.';

  @override
  String get scrumWorkflowStatusContent =>
      'En Scrum, le cycle de vie d\'une histoire suit ces états:\n\n1. **Product Backlog**: Où les idées naissent. Le label \'Refinement\' indique que l\'histoire est en cours d\'analyse/détail (ce n\'est pas une colonne du tableau, juste un indicateur).\n2. **Ready**: L\'histoire est prête à être travaillée (respecte la Definition of Ready).\n3. **In Sprint**: Pendant la Planification, les histoires \'Ready\' sont déplacées dans le Sprint.\n4. **In Progress**: L\'histoire est activement travaillée.\n5. **In Review**: L\'histoire est en phase de revue/code review.\n6. **Done**: L\'histoire est terminée et vérifiée.';

  @override
  String get kanbanWorkflowStatusContent =>
      'En Kanban, le flux est continu:\n\n1. **Refinement**: Colonne dédiée pour analyser les demandes entrantes.\n2. **Ready**: Files d\'attente pour le travail prêt (système pull).\n3. **Active Board**: Les histoires circulent à travers les colonnes de travail.\n4. **WIP Limits**: Chaque colonne a une limite pour éviter les goulots d\'étranglement.';
  ...
  @override
  String get profileIntegrations => 'Intégrations';

  @override
  String get profileJiraIntegration => 'Intégration Jira';

  @override
  String get profileJiraIntegrationDesc =>
      'Connecter pour importer les stories';

  @override
  String get jiraDomain => 'Domaine Jira';
  ...
  @override
  String get jiraConnect => 'Connecter';

  @override
  String get jiraDisconnect => 'Déconnecter';

  @override
  String get jiraSettingsSaved => 'Paramètres enregistrés';

  @override
  String get jiraSettingsCleared => 'Paramètres supprimés';
  ...
  @override
  String get agileNotNow => 'Pas maintenant';
  ...
  @override
  String get agileReviewRecapTitle => 'Récapitulatif de la revue de Sprint';

  @override
  String get agileReviewApproved => 'Approuvé';

  @override
  String get agileReviewRefinement => 'À affiner';

  @override
  String get agileReviewRejected => 'Rejeté';
  ...
  @override
  String get estimationTeamTab => 'Équipe';
  ...
  @override
  String get genericWarningTitle => 'Avertissement';

  @override
  String get skipRevealedStoryWarning =>
      'Cette histoire a été révélée et contient des votes. Êtes-vous sûr de vouloir la passer et perdre les votes actuels ?';

  @override
  String get skipRevealedStoryConfirm => 'Oui, passer';
  ...
  @override
  String get langIndonesian => 'Indonésien';
  ...
  @override
  String get actionItemStatus => 'Statut';

  @override
  String get actionStatusOpen => 'Ouvert';

  @override
  String get actionStatusInProgress => 'En Cours';

  @override
  String get actionStatusCompleted => 'Terminé';

  @override
  String get actionStatusDeferred => 'Différé';

  @override
  String get retroSectionActive => 'Active';

  @override
  String get retroSectionHistory => 'Historique';

  @override
  String get retroSectionActionTracker => 'Action Items';

  @override
  String get retroSectionLessonsLearned => 'Leçons Apprises';

  @override
  String get retroNoActiveRetro => 'Pas de rétrospective active';

  @override
  String get retroStartNew => 'Nouvelle Rétrospective';

  @override
  String get retroHistoryEmpty => 'Aucune rétrospective terminée';

  @override
  String get retroViewSummary => 'Voir le Résumé';

  @override
  String get retroSummaryTitle => 'Résumé de la Rétrospective';
  ...
  @override
  String get retroSummarySentiment => 'Sentiment de l\'Équipe';

  @override
  String get actionTrackerTitle => 'Tracker d\'Action Items';

  @override
  String get actionTrackerEmpty => 'Aucun action item dans les rétrospectives';

  @override
  String get actionTrackerFilterByAssignee => 'Filtrer par assigné';

  @override
  String get actionTrackerFilterByStatus => 'Filtrer par statut';

  @override
  String get actionTrackerFilterByRetro => 'Filtrer par rétrospective';

  @override
  String get actionTrackerCompletionRate => 'Taux de Complétion';

  @override
  String get actionTrackerCarryForward => 'Reporter';

  @override
  String get actionTrackerCarryForwardDesc =>
      'Ces action items des rétrospectives précédentes sont encore ouverts :';

  @override
  String get actionTrackerCarryForwardConfirm =>
      'Reporter les éléments sélectionnés';

  @override
  String get lessonsLearnedTitle => 'Registre des Leçons Apprises';

  @override
  String get lessonsLearnedEmpty => 'Aucune leçon apprise enregistrée';

  @override
  String get lessonsLearnedCreate => 'Ajouter une Leçon Apprise';

  @override
  String get lessonsLearnedEdit => 'Modifier la Leçon Apprise';

  @override
  String get lessonsLearnedDelete => 'Supprimer la Leçon Apprise';
  ...
  @override
  String get lessonCategoryProcess => 'Processus';

  @override
  String get lessonCategoryTechnical => 'Technique';

  @override
  String get lessonCategoryTeam => 'Équipe';

  @override
  String get lessonCategoryCommunication => 'Communication';

  @override
  String get lessonCategoryTools => 'Outils';

  @override
  String get lessonCategoryQuality => 'Qualité';

  @override
  String get lessonCategoryEstimation => 'Estimation';

  @override
  String get lessonTypeStrength => 'Point Fort';

  @override
  String get lessonTypeWeakness => 'Faiblesse';

  @override
  String get lessonTypeRecommendation => 'Recommandation';

  @override
  String get lessonFieldTitle => 'Titre';

  @override
  String get lessonFieldDescription => 'Description';

  @override
  String get lessonFieldRootCause => 'Cause Racine';

  @override
  String get lessonFieldRecommendation => 'Recommandation';

  @override
  String get lessonFieldTags => 'Tags';

  @override
  String get lessonIsRecurring => 'Modèle Récurrent';
  ...
  @override
  String get lessonIsResolved => 'Résolue';

  @override
  String get generateLessonsTitle => 'Générer les Leçons Apprises';

  @override
  String get generateLessonsDesc =>
      'Revoyez les insights de cette rétrospective et sauvegardez-les comme leçons apprises.';

  @override
  String get generateLessonsFromCards => 'Suggérées depuis les cartes';

  @override
  String get generateLessonsFromActions => 'Suggérées depuis les action items';
  ...
  @override
  String get generateLessonsSave => 'Sauvegarder les Leçons Sélectionnées';

  @override
  String get retroTrendTitle => 'Tendances d\'Amélioration de l\'Équipe';

  @override
  String get retroTrendSentiment => 'Sentiment dans le Temps';

  @override
  String get retroTrendActionCompletion => 'Taux de Complétion des Actions';

  @override
  String get retroTrendImproving => 'L\'équipe s\'améliore !';

  @override
  String get retroTrendStable => 'Performance stable';

  @override
  String get retroTrendDeclining => 'Attention nécessaire';

  @override
  String get crossProjectImport => 'Importer d\'Autres Projets';

  @override
  String get crossProjectImportActions => 'Importer les Action Items';

  @override
  String get crossProjectImportLessons => 'Importer les Leçons Apprises';

  @override
  String get crossProjectSelectProject => 'Sélectionner le Projet';

  @override
  String get crossProjectNoProjects => 'Aucun autre projet trouvé';
  ...
  @override
  String get crossProjectAggregatedView => 'Leçons Cross-Projet';

  @override
  String get tooltipTrackerStatusClick => 'Cliquez pour changer le statut';

  @override
  String get tooltipTrackerFilterStatus =>
      'Filtrer les actions par statut actuel';

  @override
  String get tooltipTrackerFilterAssignee =>
      'Filtrer par personne assignee a l\'action';

  @override
  String get tooltipTrackerFilterRetro =>
      'Filtrer par retrospective d\'origine';

  @override
  String get tooltipTrackerCompletionRate =>
      'Pourcentage de toutes les actions terminees';

  @override
  String get tooltipTrackerOverdue =>
      'Cette action a depasse sa date d\'echeance';

  @override
  String get tooltipPriorityCritical => 'Critique: A traiter immediatement';

  @override
  String get tooltipPriorityHigh => 'Haute: A traiter dans le sprint';

  @override
  String get tooltipPriorityMedium =>
      'Moyenne: A planifier pour les prochains sprints';

  @override
  String get tooltipPriorityLow => 'Basse: A traiter quand c\'est possible';

  @override
  String get tooltipLessonCategoryFilter =>
      'Filtrer les lecons par domaine d\'impact';

  @override
  String get tooltipLessonTypeFilter =>
      'Filtrer par type: force, faiblesse ou recommandation';

  @override
  String get tooltipLessonResolvedFilter =>
      'Afficher toutes, seulement non resolues, ou seulement resolues';

  @override
  String get tooltipLessonRecurring =>
      'Cette lecon a ete observee plusieurs fois dans les retrospectives';

  @override
  String get tooltipLessonResolved => 'Cette lecon a ete traitee et resolue';

  @override
  String get tooltipLessonImport =>
      'Importer des lecons apprises d\'autres projets dont vous etes proprietaire';

  @override
  String get tooltipLessonAdd =>
      'Enregistrer une nouvelle lecon apprise pour ce projet';

  @override
  String get tooltipLessonLongPressDelete =>
      'Appuyez longuement sur une lecon pour la supprimer';

  @override
  String get tooltipCarryForwardDesc =>
      'Reporter les actions non terminees des retrospectives precedentes dans la nouvelle';

  @override
  String get tooltipCarryForwardSelectAll =>
      'Selectionner ou deselectionner toutes les actions en attente';

  @override
  String get tooltipCrossProjectImportDesc =>
      'Les lecons seront copiees dans le projet actuel avec reference a la source';

  @override
  String get tooltipTrendSentiment =>
      'Score moyen du sentiment de l\'equipe (1-5) au fil du temps';

  @override
  String get tooltipTrendCompletion =>
      'Pourcentage d\'actions terminees par retrospective au fil du temps';

  @override
  String get tooltipTrendImproving =>
      'Les metriques de l\'equipe s\'ameliorent';

  @override
  String get tooltipTrendDeclining =>
      'Les metriques de l\'equipe sont en baisse - envisagez d\'adresser les causes';

  @override
  String get tooltipTrendStable =>
      'Les metriques de l\'equipe sont stables dans les retrospectives recentes';

  @override
  String get tooltipHistoryRetroCard =>
      'Cliquez pour voir le resume complet de la retrospective';

  @override
  String get tooltipHistorySentiment =>
      'Sentiment moyen de l\'equipe pour cette retrospective';

  @override
  String get tooltipHistoryActionCount =>
      'Actions terminees vs totales de cette retrospective';

  @override
  String get tooltipFormRootCause =>
      'Decrivez la cause sous-jacente qui a mene a cette observation';

  @override
  String get tooltipFormRecommendation =>
      'Suggerez des actions concretes pour traiter ou reproduire cette decouverte';

  @override
  String get tooltipFormTags =>
      'Ajoutez des tags separes par des virgules pour categoriser et rechercher';

  @override
  String get tooltipFormRecurring =>
      'Activez si cette lecon est apparue dans plusieurs retrospectives';

  @override
  String get tooltipFormResolved =>
      'Marquez comme resolue quand l\'equipe a traite cette lecon';

  @override
  String get guideActionTrackingTitle => 'Bonnes Pratiques pour les Actions';

  @override
  String get guideActionTrackingDesc =>
      'Utilisez les criteres SMART: Specifique, Mesurable, Atteignable, Pertinent, Temporel. Assignez un seul responsable, fixez une echeance dans le sprint et verifiez la progression dans la prochaine retrospective.';

  @override
  String get guideLessonsLearnedTitle => 'Cadre des Lecons Apprises';

  @override
  String get guideLessonsLearnedDesc =>
      'Capturez les forces (a reproduire) et les faiblesses (a ameliorer). Documentez les causes profondes et les recommandations. Etiquetez les lecons pour la reutilisation inter-projets et marquez comme resolues une fois traitees.';
  ...
  String get guideContinuousImprovementDesc =>
      'Suivez les tendances des retrospectives pour mesurer les progres. Reportez les actions non terminees. Importez des lecons d\'autres projets. Concentrez-vous sur les changements systemiques plutot que les corrections individuelles.';

  @override
  String get guideCarryForwardTitle => 'Processus de Report';

  @override
  String get guideCarryForwardDesc =>
      'Lors de la creation d\'une nouvelle retrospective, examinez les actions ouvertes et en cours des precedentes. Reportez les elements encore pertinents et re-priorisez-les dans le nouveau contexte.';
  ...
  String jiraTransitionTitle(Object transitionName) {
    return 'Compléter la Transition : $transitionName';
  }

  @override
  String get jiraTransitionInfo =>
      'Jira nécessite des informations supplémentaires pour cette transition.';

  @override
  String get jiraTransitionConfirm => 'Confirmer';

  @override
  String get jiraTransitionCancel => 'Annuler';

  @override
  String get jiraFieldRequired => 'Champ obligatoire';

  @override
  String jiraSyncSuccess(Object transitionName) {
    return 'Jira : $transitionName terminée';
  }

  @override
  String jiraSyncedTo(Object statusName) {
    return 'Jira : Synchronisé vers $statusName';
  }

  @override
  String jiraSyncFromSuccess(Object issueKey) {
    return 'Synchronisé depuis Jira : $issueKey';
  }
  ...
  String jiraSyncWarning(Object warning) {
    return 'Avertissement Sync Jira : $warning';
  }

  @override
  String get actionSyncJira => 'Synchroniser avec Jira';

  @override
  String get validationRequired => 'Obligatoire';

  @override
  String get jiraInvalidDomain => 'Domaine non valide';

  @override
  String get jiraInvalidEmail => 'Email non valide';

  @override
  String get jiraCreateTokenLink => 'Créer un Token API >';

  @override
  String get agileHelpTitle => 'Guide Rapide';

  @override
  String get agileHelpStep1Title => 'Remplissez le Backlog';

  @override
  String get agileHelpStep1Desc =>
      'Créez des User Stories dans l\'onglet Backlog pour définir le travail à réaliser.';

  @override
  String get agileHelpStep2Title => 'Planifiez le Sprint';

  @override
  String get agileHelpStep2Desc =>
      'Allez dans l\'onglet Sprint, créez un nouveau sprint et sélectionnez les stories du backlog.';

  @override
  String get agileHelpStep3Title => 'Travaillez sur la Board';

  @override
  String get agileHelpStep3Desc =>
      'Utilisez l\'onglet Board pour visualiser la progression. Glissez les cartes pour mettre à jour le statut.';

  @override
  String get agileHelpStep4Title => 'Synchronisez et Clôturez';

  @override
  String get agileHelpStep4Desc =>
      'Si Jira est connecté, les statuts se mettent à jour automatiquement. Utilisez \'Terminer le Sprint\' pour clôturer.';
  ...
  @override
  String get exportCsvSelected => 'Exportation CSV démarrée...';

  @override
  String get errorExportingCsv => 'Échec de l\'exportation CSV';
}
